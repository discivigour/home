...
public class CrowdUtil {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        FileInputStream fis = new FileInputStream("atcrowdfunding01-admin-parent/atcrowdfunding05-common-util/333.jpg");
        ResultEntity<String> res = uploadFileToOss
                ("http://oss-cn-chengdu.aliyuncs.com", "LTAI4FyZah3venX36Y5KT36d",
                "4lOiREvfuLqPdJJqU4Do992lJ7ZxTc", fis, "atguigu-201124",
                "http://atguigu-201124.oss-cn-chengdu.aliyuncs.com", "333.jpg");
