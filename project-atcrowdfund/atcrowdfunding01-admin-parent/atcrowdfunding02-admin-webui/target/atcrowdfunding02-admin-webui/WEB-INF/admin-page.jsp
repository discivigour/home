...
<script type="text/javascript">
	...
	function pageSelectCallback(pageIndex, jQuery) {
		...
		// 跳转页面
		window.location.href = "admin/getPages.html?pageNum="+pageNum+"&keyword=${param.keyword}";
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="/admin/getPages.html" method="post" class="form-inline" role="form" style="float: left;">
						...
						<!-- 新代码 -->
						<a style="float: right;" href="admin/to/addPage.html" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> 新增</a>
						<br>
										...
										<c:forEach items="${requestScope.pageInfo.list }" var="admin" varStatus="myStatus">
											<tr>
												...
												<td>
													...
													<!-- 新代码 -->
													<!-- 更新跳转-->
													<a href="admin/to/editPage.html?adminId=${admin.id }&pageNum=${requestScope.pageInfo.pageNum }&keyword=${param.keyword }" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
